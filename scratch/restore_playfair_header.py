...
if os.path.exists(html_path):
    ...
    old_fonts = 'https://fonts.googleapis.com/css2?family=Kalnia:wght@300;400&amp;display=swap'
    old_fonts_alt = 'https://fonts.googleapis.com/css2?family=Kalnia:wght@300;400;500;600;700&amp;display=swap'
    ...
    elif old_fonts_alt in content:
        content = content.replace(old_fonts_alt, new_fonts)
    ...
    # 3. Inject Rebuilt Header CSS overrides
    REBUILT_HEADER_CSS = """
...
"""
    ...
    if idx != -1:
        content = content[:idx] + REBUILT_HEADER_CSS + content[idx:]
        print("Injected rebuilt header CSS overrides.")
        
    # 4. Update header text labels in index.html HTML markup to match Playfair Display header text specifications
    ...
    print("Successfully restored the custom Playfair Display header layout on index.html.")
else:
