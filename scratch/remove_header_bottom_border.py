...
HEADER_FIX_CSS = """
  ...
  @media screen and (min-width: 769px) {
    ...
    /* Show and style the text logo in the center with plum color */
    ...
    body header .kavita-khosla-group .kavita-khosla4 {
      ...
      color: #4d1741 !important; /* Exact plum color from the screenshot */
...
for page in pages:
    if os.path.exists(page):
        ...
        if si != -1 and ei != -1:
            ...
            print(f"Successfully updated desktop plum text header layout in: {page}")
        else:
            print(f"Error: Centered header style block markers not found in {page}!")
    else:
